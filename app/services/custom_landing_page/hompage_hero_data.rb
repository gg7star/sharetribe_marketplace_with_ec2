  ...
  "sections": [
    {
      "id"=>"hero",
      "kind"=>"hero",
      "variation"=>{"id"=>"search_type", "type"=>"marketplace_data", "value"=>"keyword_and_location_search"},
      "title"=>{"id"=>"slogan", "type"=>"marketplace_data", "value"=>"Happiness Delivered"},
      "subtitle"=>{"id"=>"description", "type"=>"marketplace_data", "value"=>"Request a pup to play with, direct to you"},
      "background_image"=>{"id"=>"default_hero_background", "src"=>"landing_page/default_hero_background.jpg",
      "content_type"=>"image/jpeg"},
      "background_image_variation"=>"dark",
      "search_button"=>{"id"=>"search_button", "type"=>"translation", "value"=>"Search"},
      "search_path"=>{"id"=>"search", "type"=>"path", "value"=>"/s"},
      "search_placeholder"=>{"id"=>"search_placeholder", "type"=>"marketplace_data", "value"=>"Enter city"},
      "search_location_with_keyword_placeholder"=>{"id"=>"search_location_with_keyword_placeholder", "type"=>"marketplace_data", "value"=>"Location"},
      "signup_path"=>{"id"=>"signup", "type"=>"path", "value"=>"/signup"},
      "signup_button"=>{"id"=>"signup_button", "type"=>"translation", "value"=>"Sign up"},
      "search_button_color"=>{"id"=>"primary_color", "type"=>"marketplace_data", "value"=>[255, 0, 0]},
      "search_button_color_hover"=>{"id"=>"primary_color_darken", "type"=>"marketplace_data", "value"=>[217, 0, 0]},
      "signup_button_color"=>{"id"=>"primary_color", "type"=>"marketplace_data", "value"=>[255, 0, 0]},
      "signup_button_color_hover"=>{"id"=>"primary_color_darken", "type"=>"marketplace_data", "value"=>[217, 0, 0]}
    },
    {
      "id": "video",
      "kind": "video",
